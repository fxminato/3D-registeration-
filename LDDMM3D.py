...
if __name__ == "__main__":
    ...
    mrc = mrcfile.open('/Users/minato/workspace/Compressed_Sensing/pythonProject/pyLDDMM/emd_21546.map', permissive=True, mode='r')
    i0=mrc.data
    mrc = mrcfile.open('/Users/minato/workspace/Compressed_Sensing/pythonProject/pyLDDMM/emd_21546_ffit_into_emd_21547.mrc', permissive=True, mode='r')
    i1=mrc.data
